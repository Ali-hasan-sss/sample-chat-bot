...
> = {
  ...
  furnished: {
    en: "Yes — fully furnished: bed, desk, chair, wardrobe, private bathroom, and kitchen or kitchenette. Just bring your personal items. 🛋️",
    de: "Ja — voll möbliert: Bett, Schreibtisch, Stuhl, Kleiderschrank, eigenes Bad und Küche oder Kochnische. Nur persönliche Sachen mitbringen. 🛋️",
    fr: "Oui — entièrement meublé : lit, bureau, chaise, armoire, salle de bain privée et cuisine ou kitchenette. Apportez vos affaires personnelles. 🛋️",
  },
  access: {
